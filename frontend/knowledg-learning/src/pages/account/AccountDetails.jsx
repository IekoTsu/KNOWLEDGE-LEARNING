/**
 * @fileoverview AccountDetails page component for managing user profile information and viewing payment history
 */
...
/**
 * @component
 * @description Allows users to view and update their profile information and view payment history.
 * Includes form for updating name and email, and displays a list of past payments in an accordion.
 * 
 * Features:
 ...
 * )
 * 
 * @returns {JSX.Element} Rendered account details page
 */
const AccountDetails = () => {
    ...
    /**
     * Fetches user payment history on component mount
     */
    useEffect(() => {
