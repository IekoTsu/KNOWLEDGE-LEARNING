    ...
    <div className='lesson-form-container'>
      {lesson && (
        <form className='lesson-form'>
            ...
            <input type='number' id='order' max={maxOrder} min={1} value={order} onChange={(e) => setOrder(e.target.value)} required />
            ...
            <button className='common-button' type='submit' onClick={handleSubmit}>Save</button>
        </form>
      )}
    </div>
  ) 
