/**
 * @fileoverview UsersList component displays a list of users with options to update, unenroll from courses, or delete them
 */
...
/**
 * @component
 * @description Displays a list of users with administrative controls for updating user details,
 * unenrolling users from courses, and deleting users. Includes functionality to copy user IDs to clipboard.
 * 
 * @example
 * return (
 *   <UsersList />
 * )
 * 
 * @returns {JSX.Element} Rendered list of users with administrative controls
 */
const UsersList = () => {
