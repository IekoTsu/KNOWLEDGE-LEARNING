/**
 * @fileoverview Loading component displays an animated pencil as a loading indicator
 */
...
/**
 * @component
 * @description Renders an animated pencil SVG as a loading indicator.
 * The animation includes rotating pencil strokes and eraser movements.
 ...
 * )
 * 
 * @returns {JSX.Element} Rendered loading animation
 */
const Loading = () => {
  return (
